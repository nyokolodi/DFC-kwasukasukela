-- Keep the repository schema aligned with the production DFC database.
-- Safe to re-run: indexes are idempotent and the catalog view is rebuilt atomically by migration.
